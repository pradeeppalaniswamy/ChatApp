...
<html>
    ...
    <body>
      ...
      if($frndname==""){
         ...
         for($i=0;$i<count($friendlist);$i++ )
 ...
 </img></td><td>  <div class='well well-sm' >srch =".$tempfrnd[0]."
</td><td><input type='submit'class='addfriendem btn btn-success' value='Add friend' id='addfriendem".$tempfrnd[2]."'>
</div>
</td>
</tr>";
                       ...
                       $friendlist=  findfriendrequests($frndname);
                       for($i=0;$i<count($friendlist);$i++ )
                        { $flag=1;
                        $tempfrnd=   $friendlist[$i];
                         echo" <tr><td> <img src='getprofilepic.php?id=".$tempfrnd[2]."' alt=''  class='img-rounded ' height='50' width='50'>
 </img></td><td> <div class='well well-sm' >srch =".$tempfrnd[0]."&nbsp;&nbsp;&nbsp;</td><td><input type='submit'class='btn btn-warning rmfrnd' value='Cancel friend request ' id='rmfrnd".$tempfrnd[2]."'></div></td></tr> ";
        
                        } 


 $friendlist=  findfriendrequests1($frndname);
                       for($i=0;$i<count($friendlist);$i++ )
                        { $flag=1;
                        $tempfrnd=   $friendlist[$i];
                         echo" <tr><td> <img src='getprofilepic.php?id=".$tempfrnd[2]."' alt=''  class='img-rounded ' height='50' width='50'>
 </img></td><td> <div class='well well-sm' >srch =".$tempfrnd[0]."&nbsp;&nbsp;&nbsp;</td><td><input type='submit'class='btn btn-primary accfrnreq' id = 'accfrnreq".$tempfrnd[2]."' value ='Accept friend request'></div></td></tr> ";
           ...
           for($i=0;$i<count($friendlist);$i++ )
                        ...
                        $tempfrnd=   $friendlist[$i];
                         echo" <tr><td> <img src='getprofilepic.php?id=".$tempfrnd[2]."' alt=''  class='img-rounded ' height='50' width='50'>
 </img></td><td> <div class='well well-sm' >srch =".$tempfrnd[0]."&nbsp;&nbsp;&nbsp;</td><td><input type='submit'class='btn btn-danger rmfrnd' value='Un friend' id='rmfrnd".$tempfrnd[2]."'></div></td></tr> ";
         ...
         for($i=0;$i<count($friendlist);$i++ )
                        ...
                        $tempfrnd=   $friendlist[$i];
                         echo"  <tr><td> <img src='getprofilepic.php?id=".$tempfrnd[2]."' alt=''  class='img-rounded ' height='50' width='50'>
 </img></td><td> <div class='well well-sm' >srch =".$tempfrnd[0]."<td><input type='submit'class='addfriendem btn btn-success' value='Add friend' id='addfriendem".$tempfrnd[2]."'></div></td></tr>";
